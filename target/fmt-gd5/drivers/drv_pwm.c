...
#define MAX_PWM_OUT_CHAN      16            // Main Out has 16 pwm channel
...
static void pwm_gpio_init(void)
{
    ...
    /* Configure PA15 PB3 PA2 PA3 (TIMER1 CH0 CH1 CH2 CH3) as alternate function */
    gpio_mode_set(GPIOA, GPIO_MODE_AF, GPIO_PUPD_NONE, GPIO_PIN_3 | GPIO_PIN_2 | GPIO_PIN_15);
    gpio_output_options_set(GPIOA, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ, GPIO_PIN_3 | GPIO_PIN_2 | GPIO_PIN_15);

    gpio_mode_set(GPIOB, GPIO_MODE_AF, GPIO_PUPD_NONE, GPIO_PIN_3);
    gpio_output_options_set(GPIOB, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ, GPIO_PIN_3);

    gpio_af_set(GPIOA, GPIO_AF_1, GPIO_PIN_3 | GPIO_PIN_2 | GPIO_PIN_15);
    gpio_af_set(GPIOB, GPIO_AF_1, GPIO_PIN_3);

    /* Configure PB0 PB1 (TIMER2 CH2 CH3) as alternate function */
    ...
    gpio_af_set(GPIOB, GPIO_AF_2, GPIO_PIN_0 | GPIO_PIN_1);

    /* Configure PA0 PA1 (TIMER4 CH0 CH1) as alternate function */
    ...
    /* Configure PD12 PD13 PD14 PD15 (TIMER3 CH0 CH1 CH2 CH3) as alternate function */
...
rt_inline void __write_pwm(uint8_t chan_id, float dc)
{
    ...
    case 9:
        ...
        break;
    case 10:
        timer_channel_output_pulse_value_config(TIMER2, TIMER_CH_2, PWM_ARR(__pwm_freq) * dc - 1);
        break;
    case 11:
        timer_channel_output_pulse_value_config(TIMER2, TIMER_CH_3, PWM_ARR(__pwm_freq) * dc - 1);
        break;
    case 12:
        timer_channel_output_pulse_value_config(TIMER1, TIMER_CH_2, PWM_ARR(__pwm_freq) * dc - 1);
        break;
    case 13:
        timer_channel_output_pulse_value_config(TIMER3, TIMER_CH_0, PWM_ARR(__pwm_freq) * dc - 1);
        break;
    case 14:
        timer_channel_output_pulse_value_config(TIMER4, TIMER_CH_0, PWM_ARR(__pwm_freq) * dc - 1);
        break;
    case 15:
        timer_channel_output_pulse_value_config(TIMER4, TIMER_CH_1, PWM_ARR(__pwm_freq) * dc - 1);
        break;
    default:
        return;
    }
...
static rt_err_t __set_pwm_frequency(uint16_t freq)
{
    ...
    timer_autoreload_value_config(TIMER2, PWM_ARR(__pwm_freq) - 1);
    timer_autoreload_value_config(TIMER3, PWM_ARR(__pwm_freq) - 1);
    timer_autoreload_value_config(TIMER4, PWM_ARR(__pwm_freq) - 1);
