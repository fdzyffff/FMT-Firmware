...
rt_err_t drv_spi_init(void)
{
    ...
    /* attach spi_device_0 (BMI088 ACCEL) to spi0 */
    {
        ...
        static struct gd32_spi_cs spi0_cs0 = { .gpio_periph = GPIOE, .pin = GPIO_PIN_4 };
    ...
    /* attach spi_device_1 (BMI088 GYRO) to spi0 */
    {
        ...
        static struct gd32_spi_cs spi0_cs1 = { .gpio_periph = GPIOE, .pin = GPIO_PIN_5 };
    ...
    /* attach spi_device_1 (SD_Nand) to spi1 */
    {
        static struct rt_spi_device rt_spi1_dev1;
        static struct gd32_spi_cs spi1_cs1 = { .gpio_periph = GPIOE, .pin = GPIO_PIN_3 };
