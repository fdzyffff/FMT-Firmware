...
#define AC_ATTITUDE_ACCEL_RP_CONTROLLER_MAX_RADSS       radians(180.0f)  // maximum body-frame acceleration limit for the stability controller (for roll and pitch axis)
...
#define AC_ATTITUDE_ACCEL_Y_CONTROLLER_MAX_RADSS        radians(60.0f)  // maximum body-frame acceleration limit for the stability controller (for yaw axis)
#define AC_ATTITUDE_CONTROL_SLEW_YAW_DEFAULT_CDS        2000.0f   // constraint on yaw angle error in degrees.  This should lead to maximum turn rate of 10deg/sec * Stab Rate P so by default will be 45deg/sec.
#define AC_ATTITUDE_CONTROL_ACCEL_RP_MAX_DEFAULT_CDSS   20000.0f // default maximum acceleration for roll/pitch axis in centidegrees/sec/sec
#define AC_ATTITUDE_CONTROL_ACCEL_Y_MAX_DEFAULT_CDSS    6000.0f  // default maximum acceleration for yaw axis in centidegrees/sec/sec 
