...
public:
    ...
    void set_hover_roll_trim_scalar(float scalar) override {_hover_roll_trim_scalar = apm_constrain_float(scalar, 0.0f, 1.0f);}
...
private:
    ...
    float get_roll_trim_rad() override { return apm_constrain_float(radians(_hover_roll_trim_scalar * _hover_roll_trim * 0.01f), -radians(10.0f),radians(10.0f));}
