...
int16_t AP_Motors::calc_pwm_output_1to1(float input, const SRV_Channel *servo)
{
    ...
    input = apm_constrain_float(input, -1.0f, 1.0f);
    ...
    return apm_constrain_int16(ret, servo->get_output_min(), servo->get_output_max());
}
...
int16_t AP_Motors::calc_pwm_output_0to1(float input, const SRV_Channel *servo)
{
    ...
    input = apm_constrain_float(input, 0.0f, 1.0f);
