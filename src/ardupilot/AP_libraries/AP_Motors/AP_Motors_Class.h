...
public:
    ...
    void                set_throttle_avg_max(float throttle_avg_max) { _throttle_avg_max = apm_constrain_float(throttle_avg_max,0.0f,1.0f); };   // range 0 ~ 1
    ...
    float               get_throttle() const { return apm_constrain_float(_throttle_filter.get(),0.0f,1.0f); }
    float               get_throttle_bidirectional() const { return apm_constrain_float(2*(_throttle_filter.get()-0.5f),-1.0f,1.0f); }
    ...
    pwm_type            get_pwm_type(void) const { return (pwm_type)_pwm_type; }
