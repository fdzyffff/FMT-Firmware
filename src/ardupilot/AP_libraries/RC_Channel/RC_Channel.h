...
public:
    ...
    */
    ...
    int16_t    get_radio_min() const {return radio_min;}
    void       set_radio_min(int16_t val) { radio_min = val;}

    int16_t    get_radio_max() const {return radio_max;}
    void       set_radio_max(int16_t val) {radio_max = val;}

    int16_t    get_radio_trim() const { return radio_trim;}
    void       set_radio_trim(int16_t val) { radio_trim = (val);}
    ...
    int16_t    radio_min; //para
    int16_t    radio_trim; //para
    int16_t    radio_max; //para
