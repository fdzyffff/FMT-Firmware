...
void APM_Copter_Init_Para_P1(void)
{
    ...
    param_link_variable(PARAM_GET(APM, FLOW_FILT_HZ0.f),    &copter->flowhold_t.flow_filter_hz);
    param_link_variable(PARAM_GET(APM, FLOW_QUAL_MIN0),     &copter->flowhold_t.flow_min_quality);
    param_link_variable(PARAM_GET(APM, FLOW_BRAKE_RATE),    &copter->flowhold_t.brake_rate_dps);
