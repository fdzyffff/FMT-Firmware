...
void Copter::guided_cal_posvel(const Vector3f base_pos, const float base_vel_xy, const float base_yaw_angle, const bool do_land)
{
    ...
    if (heading_invalid) {
        ...
        dest_vel_ff.x = constrain_float(speed_max * tmp_delta_pos.x/L1_length, -pos_control->get_speed_xy(), pos_control->get_speed_xy());
        dest_vel_ff.y = constrain_float(speed_max * tmp_delta_pos.y/L1_length, -pos_control->get_speed_xy(), pos_control->get_speed_xy());
    } else {
        ...
        dest_vel_ff.x = constrain_float(speed_max_x * tmp_delta_pos.x/L1_length, -pos_control->get_speed_xy(), pos_control->get_speed_xy());
        dest_vel_ff.y = constrain_float(speed_max_y * tmp_delta_pos.y/L1_length, -pos_control->get_speed_xy(), pos_control->get_speed_xy());
...
//    float speed_max = guided_max_speed(error, pos_control->get_pos_xy_kP(), pos_control->get_accel_xy());
//    dest_vel_ff.x = constrain_float(speed_max * delta_pos.x/delta_length, -pos_control->get_speed_xy(), pos_control->get_speed_xy());
//    dest_vel_ff.y = constrain_float(speed_max * delta_pos.y/delta_length, -pos_control->get_speed_xy(), pos_control->get_speed_xy());
